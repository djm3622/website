...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  ...
  <div style="text-align: left; display: flex; flex-direction: column; width: calc(100% - 220px);">
    <a href="https://yourusername.github.io/djm3622/time_op"><strong>Time Invariant Operator Guided Diffusion</strong></a>
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="cond.png" alt="Project 3 Thumbnail" style="width: 200px; height: 200px; margin-right: 20px; object-fit: cover;">
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="pred.gif" alt="Project 2 Thumbnail" style="width: 200px; height: 200px; margin-right: 20px; object-fit: cover;">
  <div style="text-align: left; display: flex; flex-direction: column; justify-content: space-between; width: calc(100% - 220px);">
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="gaussbubble.gif" alt="Project 3 Thumbnail" style="width: 200px; height: 200px; margin-right: 20px; object-fit: cover;">
  <div style="text-align: left; display: flex; flex-direction: column; justify-content: space-between; width: calc(100% - 220px);">
