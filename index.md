...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <div style="text-align: left; display: flex; flex-direction: column; width: calc(100% - 220px);">
    <p>I am a double major in Computer Science and Statistics at the Rochester Institute of Technology (RIT). My research interests lie in probabilistic machine learning, multi-modal systems, and numerical weather prediction. Currently, I am working on integrating the extensive literature of probabilistic deep learning and operator learning to generate long-range estimates of partial differential equations (PDEs), with a focus on idealized atmospheric dynamics.</p>
    <p>I am actively seeking a doctoral program to further broaden my research and contribute to advancements in these fields.</p>
