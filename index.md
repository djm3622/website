...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="imgs/unet_01_pred_operator_base_conds.gif" alt="Project 2 Thumbnail" style="width: 200px; height: 200px; margin-right: 20px; object-fit: cover;">
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="imgs/gaussbubble.gif" alt="Project 3 Thumbnail" style="width: 200px; height: 200px; margin-right: 20px; object-fit: cover;">
  <div style="text-align: left; display: flex; flex-direction: column; justify-content: space-between; width: calc(100% - 220px);">
